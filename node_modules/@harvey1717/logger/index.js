...
class Logger {
  log(msg) {
    console.log(
      `[${chalk.yellow(getTime())}] [${chalk.yellow('LOG')}] - ${chalk.yellow(
        msg
      )}`
    );
  }
  ...
  success(msg) {
    console.log(
      `[${chalk.yellow(getTime())}] [${chalk.green('SUC')}] - ${chalk.green(
        msg
      )}`
    );
  }
  ...
  magenta(msg) {
    console.log(
      `[${chalk.yellow(getTime())}] [${chalk.magenta('MSG')}] - ${chalk.magenta(
        msg
      )}`
    );
  }
  ...
  mmessage(msg1, msg2) {
    console.log(
      `[${chalk.yellow(getTime())}] [${chalk.blue('MSG')}] - ${chalk.blue(
        msg1
      )}`,
      msg2
    );
  ...
  merror(msg1, msg2) {
    console.log(
      `[${chalk.yellow(getTime())}] [${chalk.red('ERR')}] - ${chalk.red(msg1)}`,
      msg2
    );
  }
  warn(msg) {
    console.log(
      `[${chalk.yellow(getTime())}] [${chalk.magenta('WRN')}] - ${chalk.magenta(
        msg
      )}`
    );
  }
